...
//    private double aprilTagSpeed = 0.25;
...
//        driveFromRightPropPath.addSegment(DeadReckonPath.SegmentType.STRAIGHT, .75, 0.5);
//        driveFromRightPropPath.addSegment(DeadReckonPath.SegmentType.STRAIGHT,.75 , -0.5);
//        driveFromRightPropPath.addSegment(DeadReckonPath.SegmentType.SIDEWAYS, 10, 0.5);
//        driveFromRightPropPath.addSegment(DeadReckonPath.SegmentType.TURN, 76, -0.5);
//        driveFromRightPropPath.addSegment(DeadReckonPath.SegmentType.STRAIGHT, 12, -0.5);
//
//        // strafes RIGHT to detect desired april tag
//        driveToBoardPath.addSegment(DeadReckonPath.SegmentType.SIDEWAYS, 3.5, 0.25);
...
//        rightBoardParkPathCenter.addSegment(DeadReckonPath.SegmentType.SIDEWAYS, 9, -0.5);
//        rightBoardParkPathCenter.addSegment(DeadReckonPath.SegmentType.STRAIGHT, 4, -0.5);
//
//
