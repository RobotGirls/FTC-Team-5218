...
@Autonomous(name = "ILTBLUERIGHT1")
public class ILTBLUERIGHT1 extends Robot {
...
//                telemetry.addData("inside findAprilTagData found ID ", desiredTagID);
    ...
    public void initPaths() {
        ...
        driveToBoardPath.addSegment(DeadReckonPath.SegmentType.SIDEWAYS, 5.7, 0.25);
        ...
        driveFromRightPropPath.addSegment(DeadReckonPath.SegmentType.SIDEWAYS, 10, -0.5); // changed distance from 9 to 11
